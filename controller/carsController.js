...
exports.uploadRequestCar = upload.single("cars_data");
exports.postCars = catchAsync(async (req, res, next) => {
...
exports.getLocationOdoo = catchAsync(async (req, res, next) => {
...
exports.updateActiveCar = catchAsync(async (req, res, next) => {
